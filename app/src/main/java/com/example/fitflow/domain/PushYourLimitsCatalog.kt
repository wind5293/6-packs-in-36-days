...
object PushYourLimitsCatalog {
    ...
    private val allWorkouts: List<SupplementaryWorkout> = listOf(
        SupplementaryWorkout(
            ...
            gradientEnd = Color(0xFF00B4D8).copy(alpha = 0f),
            imageRes = com.example.fitflow.R.drawable.abs_workout,
            isFullBackground = true,
            mirrorImage = true,
            imageOffsetDp = 90,
            textColor = Color.White,
            buttonBgColor = Color.White,
            buttonTextColor = Color(0xFF1A1A2E),
            exercises = listOf(
        ...
        SupplementaryWorkout(
            ...
            gradientEnd = Color(0xFFFFB347).copy(alpha = 0f), // Will use this as the overlay
            imageRes = com.example.fitflow.R.drawable.bench_press_form,
            isFullBackground = true,
            imageOffsetDp = 90,
            textColor = Color.White,
            buttonBgColor = Color.White,
        ...
        SupplementaryWorkout(
            ...
            gradientEnd = Color(0xFF7AE582).copy(alpha = 0f),
            imageRes = com.example.fitflow.R.drawable.full_shot_woman_holding_dumbbell,
            isFullBackground = true,
            mirrorImage = false,
            imageOffsetDp = 60,
            textColor = Color.White,
        ...
        SupplementaryWorkout(
            ...
            gradientEnd = Color(0xFF9FA8DA).copy(alpha = 0f),
            imageRes = com.example.fitflow.R.drawable.lat_pulldown,
            isFullBackground = true,
            imageOffsetDp = 150,
            textColor = Color.White,
            buttonBgColor = Color.White,
        ...
        SupplementaryWorkout(
            ...
            gradientEnd = Color(0xFF4B5563).copy(alpha = 0f),
            imageRes = com.example.fitflow.R.drawable.full_body_workout,
            isFullBackground = true,
            mirrorImage = false,
            imageOffsetDp = 60,
            textColor = Color.White,
